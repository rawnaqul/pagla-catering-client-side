    ...
    return (
        <div>
            ...
            <div className='mb-5  border p-5 rounded-2xl shadow-lg'>
                <h1 className='mb-3'><span className='font-bold mr-2 text-slate-400'>Service Name:</span>  <span className='text-orange-300 font-bold text-2xl'>{serviceName}</span></h1>
                <h3 className='mb-3'><span className='font-bold mr-2 text-slate-400'>Customer Name:</span> {customer}</h3>
                <p className='mb-3'><span className='font-bold mr-2 text-slate-400'>Your Review:</span> {reviewMessage}</p>
                <label>
